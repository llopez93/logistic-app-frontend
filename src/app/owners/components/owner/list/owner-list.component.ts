...
export class OwnerListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.firstNameFilterControl.valueChanges
    ...
    this.lastNameFilterControl.valueChanges
      .pipe(debounceTime(400))
      .subscribe(value => {
    ...
    this.cuilFilterControl.valueChanges
      .pipe(debounceTime(400))
      .subscribe(value => {
  ...
  applyFilter() {
    this.ownerService.getPage(this.paginationOptions).subscribe(page => {
